...
class BVARNIG(ProbabilityModel):
    ...
    def differentiate_predictive_log_distribution(self, y, t, run_length_log_distro):
        ...
        expr1 = utils.psi(a_vec + 0.5 * p)
        expr2 = -utils.psi(a_vec)
    ...
    def get_one_step_ahead_log_loss_derivatives_power_divergence(self):
        ...
        digamma_expr_2_A = utils.psi(0.5 * (nu_2_vec))
        ...
        digamma_expr_2_B = utils.psi(0.5 * (nu_2_vec + p))
        ...
        f_2_der_log, f_2_der_sign = utils.logsumexp(
        ...
        log_integral_derivatives_val, log_integral_derivatives_sign = utils.logsumexp(
       ...
       where we have computed Int_der(alpha) in log form in STEP 2."""
        ...
        expr_1_val, expr_1_sign = utils.logsumexp(
        ...
        expr_2_val, expr_2_sign = utils.logsumexp(
            a=np.array([expr_2_A, expr_2_B]),
        ...
        """STEP 3.4: add together expr_1_val and expr_2_val, yields log of
            {[-[1/alpha^2] * f(y)^alpha  + [1/alpha]*log(f(y)) * f(y)^alpha] + 
            [[1/(alpha+1)^2] * Int(alpha) - [1/(alpha+1)] * Int_der(alpha)]}"""
        expr_val, expr_sign = utils.logsumexp(
    ...
    def objective_optimization(x, *args):
        ...
        evaluation_objective = utils.logsumexp(MVSt_log_densities + run_length_distro)
