...
class ProbabilityModel:
    ...
    def update_joint_log_probabilities(
        ...
        # CP_log_prob = utils.logsumexp(helper_log_probabilities +
        ...
        self.model_log_evidence = utils.logsumexp(self.joint_log_probabilities)
        ...
        if (
            ...
            res_val, res_sign = utils.logsumexp(
            ...
            Size is num_params x run_length_num
            """
            results_grad_1 = utils.logsumexp(
                a=np.array(
                    [
            ...
            results_grad_2 = utils.logsumexp(
                a=np.array(
                    [
                        self.model_specific_joint_log_probabilities_derivative
                        + np.log(cp_model.hazard_vector(1, t))
            ...
            CP_grad_val, CP_grad_sign = utils.logsumexp(
            ...
            if (
                ...
                joint_log_der_sum, joint_log_der_sum_signs = utils.logsumexp(
                ...
                log_evidence = utils.logsumexp(model_specific_joint_log_probs)
                part1 = (
                    self.model_specific_joint_log_probabilities_derivative
                    - log_evidence
                )
                ...
                rld_der_signs, rld_der = utils.logsumexp(
                ...
                gradient, gradient_signs = utils.logsumexp(
                    a=np.array(
                        [
                            gradients_log_predictive_val[:, 1:]
            ...
            #                sign, caron_gradient = utils.logsumexp(
            #                    a=(self.model_specific_joint_log_probabilities_derivative),
            #                    b=self.model_specific_joint_log_probabilities_derivative_sign,
    ...
    def update_alpha_derivatives(
        ...
        """
        new_derivatives, new_derivatives_sign = utils.logsumexp(
            a=np.array(
                [
        ...
        CP_derivative, CP_derivative_sign = utils.logsumexp(
                ...
                for index, rl_particle in zip(
                    ...
                    if rl_particle < alpha:
                        ...
                        if u <= rl_particle:
                            ...
                            # DEBUG: log sum exp
                            u = utils.logsumexp(np.array([u, alpha, -rl_particle]))
