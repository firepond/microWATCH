...
class BVARNIGDPD(BVARNIG):
    ...
    def alpha_param_gradient_computation(
        ...
        if self.alpha_param_learning:
            ...
            self.model_log_evidence_p_eps = scipy.special.logsumexp(joint_log_probs)
            ...
            """STEP 3.2: as before"""
            self.model_log_evidence_m_eps = scipy.special.logsumexp(joint_log_probs)
        ...
        if num_obs > 0:
            ...
            if return_sum:
                if not log_sum:
                    ...
                    sum_1_log, sign = scipy.special.logsumexp(  # E2der_m_ba * (
                        a=(
                            np.log(np.abs(E3))
